...
class MyRegisterQuest extends StatefulWidget {
  const MyRegisterQuest({
    Key? key,
  }) : super(key: key);

  @override
  _MyRegisterQuestState createState() => _MyRegisterQuestState();
}

class _MyRegisterQuestState extends State<MyRegisterQuest> {
  final MyRegQuestController _questController =
      Get.find<MyRegQuestController>();
      ...
      child: InkWell(
        onTap: () async {
          final result = await Get.to(
              () => DetailQuestPage(
                    quest: attr,
                    eBinding: eQuestBinding.registered,
                  ),
