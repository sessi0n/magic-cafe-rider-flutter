...
class PrivateClause extends StatefulWidget {
  const PrivateClause({Key? key}) : super(key: key);

  @override
  State<PrivateClause> createState() => _PrivateClauseState();
}

class _PrivateClauseState extends State<PrivateClause> {
