...
class PrivateRight extends StatefulWidget {
  const PrivateRight({Key? key}) : super(key: key);

  @override
  State<PrivateRight> createState() => _PrivateRightState();
}

class _PrivateRightState extends State<PrivateRight> {
